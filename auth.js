...
(function(){
  ...
  .mff-panel{
    ...
    min-width:max-content;max-width:calc(100vw - 68px);
    background:rgba(255,255,255,.98);border:1px solid #dce7e3;border-radius:18px;
    padding:8px 10px;box-shadow:0 14px 34px rgba(15,91,77,.22);backdrop-filter:blur(10px);
    display:flex;align-items:center;gap:10px;white-space:nowrap;
  }
  .mff-panel.mff-panel-right{right:auto;left:52px}
  .mff-panel.mff-panel-up{top:50%;bottom:auto}
  .mff-panel.mff-panel-left{right:52px;left:auto}
  ...
  .mff-panel-actions{display:flex;align-items:center;gap:6px;margin-top:0;flex-wrap:nowrap;flex:none}
